...
class TGTTracker:
    ...
    - input_src: frame source,
                    ...
                    - "tof": uses the expected hardware configuration of the OAK-D SR POE(CAM_A: TOF, CAM_B: Left OV9782 RGB, CAM_C: Right OV9782 RGB)
                    - "tof_laconic": same as "tof" but without sending the frames to the host
    ...
    - resolution : sensor resolution "full" (cam default) or "ultra" (3840x2160),
    ...
    - body_model : Movenet single pose model: "lightning", "thunder" TODO "ozone"
    ...
    def __init__(
        ...
        if input_src is None or input_src in get_args(SourceType):
            ...
            if input_src == "tof" and resolution != "full":
                print(
                    "Varying resolution for tof sensor has not been implemented, use full"
                )
                sys.exit()
            elif input_src == "tof":
        ...
        if input_src == "rgb" or input_src == "rgb_laconic":
            pass
        elif input_src == "tof" or input_src == "tof_laconic":
            # TODO
